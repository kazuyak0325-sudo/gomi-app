const CACHE_NAME = "gomi-app-midori-pet1-1790223126";
const CACHE_PREFIX = "gomi-app-midori-pet1-";
const ASSETS = ["./", "index.html", "manifest.json", "icon.png", "../../style.css?v=1790223126", "../../app.js?v=1790223126", "../../pet-icon.png"];
