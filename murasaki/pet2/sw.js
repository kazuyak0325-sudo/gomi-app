const CACHE_NAME = "gomi-app-murasaki-pet2-1790222860";
const CACHE_PREFIX = "gomi-app-murasaki-pet2-";
const ASSETS = ["./", "index.html", "manifest.json", "icon.png", "../../style.css?v=1790222860", "../../app.js?v=1790222860", "../../pet-icon.png"];
