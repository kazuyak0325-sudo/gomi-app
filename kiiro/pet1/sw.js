const CACHE_NAME = "gomi-app-kiiro-pet1-1790206380";
const CACHE_PREFIX = "gomi-app-kiiro-pet1-";
const ASSETS = ["./", "index.html", "manifest.json", "icon.png", "../../style.css?v=1790206380", "../../app.js?v=1790206380", "../../pet-icon.png"];
