const CACHE_NAME = "gomi-app-kiiro-pet2-1790206589";
const CACHE_PREFIX = "gomi-app-kiiro-pet2-";
const ASSETS = ["./", "index.html", "manifest.json", "icon.png", "../../style.css?v=1790206589", "../../app.js?v=1790206589", "../../pet-icon.png"];
