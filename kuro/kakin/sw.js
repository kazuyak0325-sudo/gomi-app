const CACHE_NAME = "gomi-app-kuro-kakin-1789966067";
const CACHE_PREFIX = "gomi-app-kuro-kakin-";
const ASSETS = ["./", "index.html", "manifest.json", "icon.png", "../../style.css?v=1789966067", "../../app.js?v=1789966067"];
