const CACHE_NAME = "gomi-app-kuro-pet1-1790223151";
const CACHE_PREFIX = "gomi-app-kuro-pet1-";
const ASSETS = ["./", "index.html", "manifest.json", "icon.png", "../../style.css?v=1790223151", "../../app.js?v=1790223151", "../../pet-icon.png"];
