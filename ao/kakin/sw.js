const CACHE_NAME = "gomi-app-ao-kakin-1789968093";
const CACHE_PREFIX = "gomi-app-ao-kakin-";
const ASSETS = ["./", "index.html", "manifest.json", "icon.png", "../../style.css?v=1789968093", "../../app.js?v=1789968093"];
