const CACHE_NAME = "gomi-app-pink-pet2-1790222979";
const CACHE_PREFIX = "gomi-app-pink-pet2-";
const ASSETS = ["./", "index.html", "manifest.json", "icon.png", "../../style.css?v=1790222979", "../../app.js?v=1790222979", "../../pet-icon.png"];
