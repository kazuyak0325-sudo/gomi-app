const CACHE_NAME = "gomi-app-pink-pet1-1790223186";
const CACHE_PREFIX = "gomi-app-pink-pet1-";
const ASSETS = ["./", "index.html", "manifest.json", "icon.png", "../../style.css?v=1790223186", "../../app.js?v=1790223186", "../../pet-icon.png"];
